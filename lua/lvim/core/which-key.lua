...
M.config = function()
  lvim.builtin.which_key = {
    ...
    mappings = {
      ...
      ["f"] = { require("lvim.core.telescope.custom-finders").find_project_files, "Git files" },
      ...
      s = {
        ...
        f = { "<cmd>lua require('telescope.builtin').find_files({hidden=true,no_ignore=true})<CR>","Find files" },
